...
export class EntidadTerritorialService {
    ...
    try {
      ...
      if (error) {
        throw new InternalServerErrorException(
          'Error al obtener entidad territorial: ' + error.message,
        );
      }
      ...
      if (!data) {
        return {
          status: false,
          message:
            'No hay entidad territorial configurada. Debes crear una primero.',
          data: undefined,
        };
      }
  ...
  async createEntidad(
    createRequest: EntidadTerritorialRequest,
  ): Promise<EntidadTerritorialResponse> {
    try {
      ...
      if (checkError) {
        throw new InternalServerErrorException(
          'Error al verificar entidad territorial: ' + checkError.message,
        );
      }
      ...
      if (existingEntity) {
        return {
          status: false,
          message:
            'Ya existe una entidad territorial. Solo puede haber una por sistema. Usa el endpoint de actualización.',
      ...
      if (error) {
        throw new InternalServerErrorException(
          'Error al crear entidad territorial: ' + error.message,
        );
      }
  ...
  async updateEntidad(
    updateRequest: EntidadTerritorialRequest,
  ): Promise<EntidadTerritorialResponse> {
    try {
      ...
      if (!existingData) {
        return {
          status: false,
          message:
            'No existe una entidad territorial configurada. Debes crear una primero.',
      ...
      if (error) {
        throw new InternalServerErrorException(
          'Error al actualizar entidad territorial: ' + error.message,
        );
      }
  ...
  async getOrganigrama(): Promise<EntidadTerritorialResponse> {
    try {
      ...
      if (error) {
        throw new InternalServerErrorException(
          'Error al obtener organigrama: ' + error.message,
        );
      }
  ...
  async updateOrganigrama(
    ...
    try {
      ...
      if (error) {
        throw new InternalServerErrorException(
          'Error al actualizar organigrama: ' + error.message,
        );
      }
    ...
    try {
      ...
      if (!existingData) {
        return {
          status: false,
          message:
            'No existe una entidad territorial configurada para eliminar.',
          error: 'Entidad no encontrada',
          data: undefined,
        };
      }
      ...
      if (error) {
        throw new InternalServerErrorException(
          'Error al eliminar entidad territorial: ' + error.message,
        );
      }
  ...
  async deleteOrganigrama(): Promise<EntidadTerritorialResponse> {
    try {
      ...
      if (error) {
        throw new InternalServerErrorException(
          'Error al eliminar organigrama: ' + error.message,
        );
      }
      ...
      return {
        status: true,
        message:
          'Organigrama eliminado correctamente. La entidad territorial se mantiene.',
        data: data as any,
        error: null,
      };
    } catch (error) {
