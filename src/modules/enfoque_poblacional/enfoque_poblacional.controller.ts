...
import {
  CreateEnfoquePoblacionalPipe,
  ValidateIdPipe,
} from './pipe/enfoque_poblacional.pipe';

@Controller('enfoque-poblacional')
@UseGuards(JwtAuthGuard, RolesGuard)
export class EnfoquePoblacionalController {
  constructor(
    private readonly enfoquePoblacionalService: EnfoquePoblacionalService,
  ) {}
  ...
  @Roles('superadmin', 'admin')
  async create(
    @Body(CreateEnfoquePoblacionalPipe)
