...
import { ProgramacionFinancieraRequest, ProgramacionFinancieraResponse } from './dto/programacion_financiera.dto';
...
export class ProgramacionFinancieraService {
    ...
    async create(createRequest: ProgramacionFinancieraRequest): Promise<ProgramacionFinancieraResponse> {
        try {
    ...
    async update(id: number, updateRequest: ProgramacionFinancieraRequest): Promise<ProgramacionFinancieraResponse> {
        try {
